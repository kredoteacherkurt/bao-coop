...
const defaultContent = {
    ...
    // STRICTLY FACTUAL HISTORY AS REQUESTED
...
function initLogin(form) {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (validUser) {
            ...
            const memberSession = { ...validUser, role: "MEMBER" };
...
function loadAdminPage() {
    ...
    if(cmsForm) {
        cmsForm.addEventListener('submit', (e) => {
            ...
            let videoFileName = JSON.parse(localStorage.getItem('siteContent')).videoFile; // maintain existing if none uploaded
...
function renderAdminTransTable() {
    ...
    db.forEach(t => {
        ...
        if (t.proofData) {
            proofDisplay = `<button onclick="viewDocument(${t.id})" style="color:blue; text-decoration:underline; border:none; background:none; cursor:pointer;">
